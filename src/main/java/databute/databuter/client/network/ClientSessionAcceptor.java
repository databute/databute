...
import databute.databuter.bucket.notification.add.BucketAddedNotificationMessageSerializer;
import databute.databuter.bucket.notification.update.BucketUpdatedNotificationMessageSerializer;
...
public class ClientSessionAcceptor extends AbstractSessionAcceptor {
    ...
    public ClientSessionAcceptor() {
        ...
        this.serializers.put(ClientMessageCode.BUCKET_ADDED_NOTIFICATION, new BucketAddedNotificationMessageSerializer());
        this.serializers.put(ClientMessageCode.BUCKET_UPDATED_NOTIFICATION, new BucketUpdatedNotificationMessageSerializer());
